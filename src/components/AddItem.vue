  ...
  <div class="container">
    <div class="button-container-3cl">
      <button
        ...
        :key="index"
        @click="changeItem(category.name, category.price)"
    ...
    <div class="preview-container">
      ...
      <button @click="formViewToggle()" class="button edit-button">
        フォーム入力
      </button>
    </div>
    ...
    <div class="button-container-3cl">
      <button @click="increment(1000)" class="button button-plus">
        +￥1,000
      </button>
      ...
      <button @click="increment(-1000)" class="button button-minus">
        -￥1,000
      </button>
      <button @click="increment(-100)" class="button button-minus">
        -￥100
      </button>
